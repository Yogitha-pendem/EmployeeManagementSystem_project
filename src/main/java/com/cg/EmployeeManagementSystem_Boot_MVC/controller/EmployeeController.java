...
@Controller
@RequestMapping("/employees")//all the urls start by this only
public class EmployeeController {
	@Autowired
	EmployeeService service;
	
	//getalllistofemployee
	@GetMapping()
	public String listEmployees(Model model) {
		model.addAttribute("list",service.getAllEmployee());
		return "employees";
	}
	//this will give the employee-form.html
	@GetMapping("/add")
	...
	public String updateEmployee(@PathVariable long id ,@ModelAttribute ("employee")Employee emp) {
